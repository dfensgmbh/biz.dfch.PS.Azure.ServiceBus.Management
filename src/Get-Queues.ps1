...
try 
{
	...
	else
	{
		...
		$CurrentNamespace = Get-SBNamespace -Name $Namespace;
		Log-Debug "The [$Namespace] namespace has been successfully created.";
	}
	...
	$OutputParameter = $NamespaceManager.GetQueues();
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-Queues; }
# SIG # Begin signature block
# MIIXDwYJKoZIhvcNAQcCoIIXADCCFvwCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCPvJtW4PT/nv6ARU8QGl9c80
# 5CGgghHCMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQkIcUOUHEqeQLn
# KU9fh8KWaJzqUDANBgkqhkiG9w0BAQEFAASCAQAie6YyDRFLEYH9gbPpZHJv7LhL
# /QETNOe5ZEz3A1XdxOUUWAidx0kkaWqlxAw9x2OkCEPMc9htJcv/0MMKsjmBkcXm
# TvTOkj2ZcAznT4l7x83xLVmVWJyJyBtQmSRKR6uT/j7OvmuZHYloyZ8BpR5h6Dj7
# BFLg8xgmPvj+FYsXSIb6H6zOMkr6a4hxY3C2vGNTxRzMLgUKpwiF50GDzZpirtvY
# u6Mg6G2OEoJxmnWsDOBLMBWG5VoPWWM310jlgK5fmoesyPRra56kSLt54QqByibq
# Iy2YTrO2L0U8Uh+5Mj71UZQCOcfQbRBMnx0TxGEN1+yaT+ollll8S+6cKvmnoYIC
# ojCCAp4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAX
# BgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGlt
# ZXN0YW1waW5nIENBIC0gRzICEhEhBqCB0z/YeuWCTMFrUglOAzAJBgUrDgMCGgUA
# oIH9MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1
# MTIwMzExNTMyMVowIwYJKoZIhvcNAQkEMRYEFAlgNBob/MH1cThQ8SCq0XdEyOGX
# MIGdBgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUs2MItNTN7U/PvWa5Vfrjv7Es
# KeYwbDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# BqCB0z/YeuWCTMFrUglOAzANBgkqhkiG9w0BAQEFAASCAQAac6sQuF/4qhrj6uvN
# gUYFcVPXFkchxer6B4rJ0WpsCrN3K4dx4qOBaokzS7NQ2xit3SZE6aC9/Razo3g4
# PEN2nViguDeHe9zhnm+JWmD9WLfuZGoLlNq9O91LtcnN4vM+cbJX/oLiCM3j0Ile
# KBxFFnfZQelIEyHXpg++nylZppMYJCOq4L4GoHpmkSWCrMIfn2+3H2hnmC/XV1Op
# eIYuU50GlaSMD7QOHyzH1I0k2+LVKkVqiWUv03ow0ebZDk1IGVPsgUIf55qs/E0A
# ptzMiTKbWXNZDKsZ77Oo2xVIBZiHQUgb7R6awvRDZr5gASr7lIjSDE1p9v2vD/ip
# nsa4
