...
try 
{
	...
	{
		$msg = "The [$Path] topic not exists in the [$Namespace] namespace.";
		$e = New-CustomErrorRecord -m $msg -cat InvalidData -o $NamespaceManager;
		Log-Error -msg $msg;
		$PSCmdlet.ThrowTerminatingError($e);
	}
	...
	{
		$SubscriptionCount = $NamespaceManager.GetTopic($Path).SubscriptionCount;
		if ( $SubscriptionCount -gt 0 ) {
			$msg = ("Subscription count [{0}] of [$Path] topic in the [$Namespace] namespace is greater than 0." -f $SubscriptionCount);
			if ( $Force ) {
				Log-Warn $fn -msg $msg;
			} else {
				$e = New-CustomErrorRecord -m $msg -cat InvalidData -o $NamespaceManager;
		...
		Log-Debug -msg "Deleting the [$Path] topic in the [$Namespace] namespace...";
		$OutputParameter = $NamespaceManager.DeleteTopic($Path);
		Log-Info -msg "The [$Path] topic in the [$Namespace] namespace has been successfully deleted.";
	}
...
if($MyInvocation.ScriptName) { Export-ModuleMember -function Remove-Topic; } 
# SIG # Begin signature block
# MIIXDwYJKoZIhvcNAQcCoIIXADCCFvwCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUtVK+s6xmcCGaW5gb9gsVqSEl
# JYegghHCMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSuh/8fyWEvVIUj
# +qmy/c8sL2xdHjANBgkqhkiG9w0BAQEFAASCAQDGMWPD5lymy3lMKgxGYMUcJyyd
# UklyqGZ8dVXoTTDFiLqoT0lAE/UmR3r2NDEG607ZlBn0yiWL3w1ChBcarPTRQCTW
# w2VFvFNID/fIABtavhyb2TRB4tTaC6AOU6AcDkSDqiFyyAq83/wgu3NBCrEWLP1i
# B+KQXVOKBXtjKKVEDsG5LyKhK9N89VnJRsY6TxKjmh0IC+YtLrXk0X++mL16q/vR
# 6ICjHOWWKyTTD5EkA0LNUF//bDvVIaO1L99pHwiNNdx7bPrIwy5XgGiwy2uvOplx
# lO5WC0h367gr9SWJzRcJA7Hd+iGED9nVEVSBdNJQ7s4AzAsL1zj1r+LTRD0/oYIC
# ojCCAp4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAX
# BgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGlt
# ZXN0YW1waW5nIENBIC0gRzICEhEhBqCB0z/YeuWCTMFrUglOAzAJBgUrDgMCGgUA
# oIH9MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1
# MTIwMzExNTMyN1owIwYJKoZIhvcNAQkEMRYEFNnaVR0XMfnvdEWlSOKqzUt0azzr
# MIGdBgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUs2MItNTN7U/PvWa5Vfrjv7Es
# KeYwbDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# BqCB0z/YeuWCTMFrUglOAzANBgkqhkiG9w0BAQEFAASCAQB+050F9wVWdoOQb0pj
# 91dQnFcn6t6+qyv07R5xqnw5spla9G4frrkgz7dcNmZuNRmiGAlFfrhV+0M9XIoR
# SWxqbLYUxROnhBeYvbT4co2kNVX3f24haod1IqdXQaXW6svBAeB+RtmSXEXtp7bX
# upHFRC9O7XUIPkEvbRUV16gzPEhntlKGrx0Yguo9RdhReNczvjUnXNapVSojP4ZI
# HbULLfhXJv+SjEWTsp8Fhw9EOmMAr1ICOFi6vJtxj4iJfazNXXQdsUXhsusQLova
# E6fVmC7N/FlKVL5jYIFsSz/2mSwJLwgigpdaKOdqk+5x35Q9HgWMcJkzEOyUkJ5Q
# tNMI
