...
try 
{
	...
	{
		Log-Debug -msg "[$Path] queue exists in [$Namespace] namespace.";
		$OutputParameter = $NamespaceManager.GetQueue($Path);
	}
	else
	{
		$msg = "[$Path] queue does not exist in [$Namespace] namespace...";
		$e = New-CustomErrorRecord -m $msg -cat InvalidData -o $NamespaceManager;
		Log-Error -msg $msg;
		$PSCmdlet.ThrowTerminatingError($e);
	}
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-Queue; }
# SIG # Begin signature block
# MIIXDwYJKoZIhvcNAQcCoIIXADCCFvwCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUmfDMUOVc+2usaBJwfUmLSi+1
# yRugghHCMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSA2yt6Hih2VoIi
# dyc76QMu8myHoDANBgkqhkiG9w0BAQEFAASCAQAamhwxMXpa2z4cgRU23mJvukyQ
# zHyWLmHADkcDYG1/P5KK5YFOEv56/p3PhiUrTYzoD8Jn+f3M1evjpoO/kTrtO55t
# o4KWIzDcpWO+p5xrB96U85IdSJI3HGe7eDvidXadgPRyWTiE2TrovR0k2akwtmWY
# 4D4vkX7BfkFhBwxTF1IlFj2SDvkal/svIykBFFtsmotehtlmQHaSBE6tcF89mVRD
# H2le61nhi0z4G3aCyH3MMPmGIh9o284lEFWw950aEDM6tnBA7Wt4hK35mGE1+I8W
# 7tdwApVKs19yFUEX4G0JLF4gS9kym2kFjB1qTSqjRhPqauNyfn/H9djtG1qSoYIC
# ojCCAp4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAX
# BgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGlt
# ZXN0YW1waW5nIENBIC0gRzICEhEhBqCB0z/YeuWCTMFrUglOAzAJBgUrDgMCGgUA
# oIH9MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1
# MTIwMzExNTMyMVowIwYJKoZIhvcNAQkEMRYEFLgqNUiAtb5umwOmz+vIxlCtywKg
# MIGdBgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUs2MItNTN7U/PvWa5Vfrjv7Es
# KeYwbDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# BqCB0z/YeuWCTMFrUglOAzANBgkqhkiG9w0BAQEFAASCAQCFlxNaKLpv/SMemnar
# Q8B/jUDUMv7R1jf2h39hY0VpZP0DYs062HVVjRY0xYbXp0+hl+NrN49CiRx0M4lP
# w6kJC6eTkLe8OFyefaPz/+dLpF22igNEKmtu5WjXs7fsFeBRi6TfGEyv80RVpIAh
# +xKW5vbnL3d3K3P013UOp49DLdaATWl8akrDf1X2oklLL6tgRdeN68NGl4DoRpDv
# a4th4mMLN1v/0r/RiMHILmNDnQiE6iDhJc5C+BTfGRSKDJXt6g27g0M1AhETr8Jk
# 5cScRtSp9U2aJXvqliLg2w5QMfp1pldjuDXFFtr4qWnsC3caKzIkhcIuBFYl+Boa
# kfIJ
